const materials = [
  {
    ...
    theoryFile: 'files/chem-theory.pd',
    practicalFile: 'files/chem-practical.pd',
  },
  {
    name: 'BME',
    icon: 'fas fa-hammer',
    description: 'BME materials including Theory and Practical',
    theoryFile: 'files/bme-theory.pd',
    practicalFile: 'files/bme-practical.pd',
  },
  {
    name: 'EVS',
    icon: 'fas fa-leaf',
    description: 'EVS materials including Theory and Practical',
    theoryFile: 'files/evs-theory.pd',
    practicalFile: 'files/evs-practical.pd',
  },
  {
    name: 'BEC',
    ...
    theoryFile: 'xyz.pd',
    practicalFile: 'files/BEC LAB COPY.pd',
  },
  {
    name: 'Physics',
    icon: 'fas fa-atom',
  ...
  },
  {
    ...
    theoryFile: 'theory.pd',
    practicalFile: 'xyz.pd',
  },
  {
    name: 'Mathematics:2',
    icon: 'fas fa-divide',
  ...
  },
  {
    ...
    theoryFile: 'files/ravish r singh bee.pd',
    practicalFile: 'files/BEE PRACTICAL.pd',
  },
];
